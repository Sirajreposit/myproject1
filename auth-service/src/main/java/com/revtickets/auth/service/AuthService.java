...
import com.revtickets.common.security.JwtTokenUtil;
import com.revtickets.auth.client.NotificationClient;
import com.revtickets.auth.client.dto.NotificationRequest;
import com.revtickets.auth.dto.AuthRequest;
import com.revtickets.auth.dto.SignupRequest;
import com.revtickets.auth.exception.UnauthorizedException;
import com.revtickets.auth.model.PasswordResetToken;
import com.revtickets.auth.model.User;
import com.revtickets.auth.repository.PasswordResetTokenRepository;
import com.revtickets.auth.repository.UserRepository;
...
public class AuthService {
    ...
    public void sendPasswordResetEmail(String email) {
        ...
        try {
            ...
            notifRequest.setEmail(email); // Ensure Notification Service handles this!
            notifRequest.setTitle("Password Reset Request");
            notifRequest.setMessage("Your password reset token is: " + token);
