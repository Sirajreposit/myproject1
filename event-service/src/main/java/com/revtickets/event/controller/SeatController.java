...
import com.revtickets.event.service.SeatService;
...
public class SeatController {
    ...
    @PostMapping("/book")
    public ResponseEntity<Void> bookSeats(@RequestBody com.revtickets.event.dto.BookSeatsRequest request) {
        seatService.bookSeats(request.getShowId(), request.getSeatNumbers(), request.getBookingId());
        return ResponseEntity.ok().build();
    }
}
